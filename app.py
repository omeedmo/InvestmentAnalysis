...
def analyze():
    ...
    # ── Company plugin overrides ─────────────────────────────────────────────
    # A few filers cannot be handled by tag mapping alone — Berkshire tags no
    # consolidated debt at all and files class-A share counts and EPS. Rather
    ...
    if _last_annual_date:
        ...
        # class-A share counts and double-counted cash).
        company_templates.call_hook(
